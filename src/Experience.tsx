...
export default function ExperienceSection() {
  return <section id="experience" className="experience work-section">
    <div className="section-heading"><div><p className="eyebrow">01 / EXPERIENCE</p><h2 className="section-title">Internships</h2></div></div>
    <div className="internship-list">{experience.map(item => <article className="internship-row" key={item.company}>
    ...
    <section id="education" className="education education-section"><p className="eyebrow">02 / EDUCATION</p><h2 className="section-title">Education</h2><div className="education-summary"><div className="education-content"><p className="card-overline">UNIVERSITY OF BRITISH COLUMBIA</p><h3>Computer Science</h3><p>Bachelor of Science</p><div className="education-meta"><span>Graduated June 2026</span><span>Vancouver, BC</span></div></div></div></section>
  </section>;
}
